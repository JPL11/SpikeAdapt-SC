...
Baselines & Internal only & SNN (no mask), CNN-Uni \\
\bottomrule
\end{tabular}
\end{table}
...
SNN (no mask, $\rho{=}1.0$) & 95.70 & 95.35 & 92.20 & 0\% \\
...
Key findings:
\begin{itemize}
    \item v2 at 75\% bandwidth \textbf{beats} the full-rate unmasked baseline by 0.65~pp clean and 0.70~pp at BER=0.30.
...
SNN (no mask, $\rho{=}1.0$) & 95.70 & 95.70 & 95.80 & 95.35 & 95.00 & 94.30 & 92.20 \\
