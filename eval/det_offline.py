...
Mondrian. Output: eval/seed_results/det_offline.json"""
import json
import time
...
json.dump(OUTJ, open("eval/seed_results/det_offline.json", "w"), indent=1)
print("WROTE det_offline.json", round(time.time() - t0, 1), "s", flush=True)
