...
\centering
\caption{Main BSC results on AID and RESISC45. AID values for $\rho{=}0.75$ include 5-seed standard deviation.}
...
\midrule
\textbf{SpikeAdapt-SC} ($\rho{=}0.75$) & \textbf{95.42}{\scriptsize($\pm$0.71)} & \textbf{93.34}{\scriptsize($\pm$2.58)} & \textbf{92.01} & \textbf{86.98} & 75\% \\
SpikeAdapt-SC ($\rho{=}0.625$) & 95.40 & 93.50 & 91.06 & 87.29 & 62.5\% \\
SNN (no mask, $\rho{=}1.0$) & 95.20 & 92.36 & 92.53 & 85.31 & 100\% \\
