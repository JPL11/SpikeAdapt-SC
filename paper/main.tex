...
\midrule
\textbf{V5C-NA} ($\rho{=}0.75$) & \textbf{95.42}{\scriptsize($\pm$0.71)} & \textbf{95.72}{\scriptsize($\pm$0.59)} & \textbf{93.34}{\scriptsize($\pm$2.58)} & 75\% \\
V5C-NA ($\rho{=}0.625$) & 95.40 & 95.62 & 93.50 & 62.5\% \\
SNN-SC~\cite{wang2024snnsc} ($\rho{=}1.0$) & 95.20 & 95.64 & 92.36 & 100\% \\
\midrule
...
\renewcommand{\arraystretch}{1.15}
\centering
\caption{Mask comparison for V5C-NA on AID (50/50). Random averaged over 50 independent draws.}
...
V5C-NA ($\rho{=}0.75$) & \textbf{95.42} & \textbf{93.34} & \textbf{92.01} & \textbf{86.98} \\
V5C-NA ($\rho{=}0.625$) & 95.40 & 93.50 & 91.06 & 87.29 \\
SNN-SC~\cite{wang2024snnsc} ($\rho{=}1.0$) & 95.20 & 92.36 & 92.53 & 85.31 \\
\bottomrule
\end{tabular}
\end{table}
...
\centering
\small
\caption{Full BER sweep accuracy (\%) on both datasets (BSC channel, V5C-NA at $\rho{=}0.75$). The $\rho{=}0.625$ advantage over $\rho{=}1.0$ (Table~\ref{tab:cross_dataset}) persists across the BER range, not only at BER${=}0.30$.}
\label{tab:ber_sweep}
...
\midrule
\multirow{5}{*}{AID} & \textbf{V5C-NA} & \textbf{95.42} & \textbf{95.64} & \textbf{95.70} & \textbf{95.72} & \textbf{95.76} & \textbf{95.16} & \textbf{93.34} \\
...
\midrule
\multirow{5}{*}{RESISC45} & \textbf{V5C-NA} & \textbf{92.01} & \textbf{92.15} & \textbf{92.31} & \textbf{92.42} & \textbf{92.31} & \textbf{91.30} & \textbf{86.98} \\
...
\midrule
\multirow{4}{*}{0.05} & V5C-NA & 95.64 & 95.56 & 95.66 & 92.15 & 92.17 & 92.17 \\
...
\midrule
\multirow{4}{*}{0.15} & V5C-NA & 95.72 & 95.72 & 95.90 & 92.42 & 92.39 & 92.40 \\
...
\midrule
\multirow{4}{*}{0.30} & \textbf{V5C-NA} & \textbf{93.34} & \textbf{93.46} & \textbf{93.50} & \textbf{86.98} & \textbf{86.94} & \textbf{86.94} \\
