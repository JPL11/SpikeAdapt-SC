...
JPEG+Conv ($R{=}1/3$) & 95.16 & 2.68 & 2.68 & $\sim$300\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
    ...
    \caption{BER sweep comparison on (a) AID and (b) RESISC45. Six baselines: V5C-NA ($\rho{=}0.75$), SNN-SC ($\rho{=}1.0$), CNN-Uni, CNN-NonUni, MLP-FC, and JPEG+Conv. SNN encoding degrades $\leq$5~pp at BER${=}0.30$; 8-bit CNN/MLP baselines collapse by 28--56~pp; JPEG+Conv exhibits a cliff effect at BER${=}0.05$.}
...
0.75 & 0.30 & \textbf{93.50} & 93.21{\scriptsize$\pm$0.11} & 93.34 & $+$\textbf{0.29} \\
\bottomrule
\end{tabular}
\end{table}
